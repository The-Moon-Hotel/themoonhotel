...
public class NoticeBoardVO {
	...
	public String toString() {
		return "NoticeBoardVO [noticeNo=" + noticeNo + ", guestNo=" + guestNo + ", n_title=" + n_title + ", n_regdate="
				+ n_regdate + ", n_content=" + n_content + ", n_count=" + n_count + ", getNoticeNo()=" + getNoticeNo()
				+ ", getGuestNo()=" + getGuestNo() + ", getN_title()=" + getN_title() + ", getN_regdate()="
				+ getN_regdate() + ", getN_content()=" + getN_content() + ", getN_count()=" + getN_count()
